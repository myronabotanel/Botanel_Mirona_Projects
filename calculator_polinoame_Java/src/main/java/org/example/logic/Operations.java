...
public class Operations {
        ...
        for (Map.Entry<Integer, Monomial> entry : p2.getPolinom().entrySet()) {
            ...
            if (result.containsKey(exponent)) {
                ...
                if (newCoefficient != 0) {
                    ...
                    result.remove(exponent); // Remove the term if coefficient becomes 0
                }
            } else {
    ...
    public static String divide(Polinom dividend, Polinom divisor) {
        ...
        Polinom result = new Polinom(); //stocam catul
        Polinom remainder = new Polinom(dividend.getPolinom());  //stocam restul
